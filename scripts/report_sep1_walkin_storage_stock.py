#!/usr/bin/env python3
"""
Report September 1st stock in WH/walkin-storage (parent location only)
"""
...
def main():
    ...
    try:
        with conn.cursor(cursor_factory=RealDictCursor) as cur:
            # Query stock_quant for products in WH/walkin-storage (parent location only)
            query = """
                SELECT 
                    pp.id as product_id,
            ...
            if products:
                print(f"\nAll Stock in WH/walkin-storage (Parent Location Only)")
                print("=" * 100)
                ...
                # Export to CSV
                csv_file = 'data/walkin_storage_stock.csv'
                ...
                print("No products found in WH/walkin-storage")
